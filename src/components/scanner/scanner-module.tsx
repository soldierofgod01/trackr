  ...
  return (
    <div className="flex-1 overflow-y-auto bg-bg-base">
      <div className="px-8 md:px-12 py-9 max-w-[1440px] mx-auto">
        ...
        {/* ─── Controls bar ─── */}
        <div className="ds-panel mb-4 px-4 py-3">
          <div className="flex items-center gap-4 flex-wrap">
            {/* Screen segmented control */}
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <div className="flex items-center gap-0.5 p-0.5 rounded-[7px] bg-bg-base border border-border">
                <button
