...
export function PressureModule() {
  ...
  const runnerUps = signals.slice(1, 5);
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-bg-base">
      <div className="px-8 md:px-10 py-7 max-w-[1400px] mx-auto">
        ...
        <div className="flex items-end justify-between mb-7 flex-wrap gap-4">
          <div>
            ...
            <p className="text-[13px] text-txt-secondary mt-1.5 leading-[1.5]">
              The strongest positioning setups on Hyperliquid right now, ranked by fit. Refreshes every 30s.
            </p>
          </div>
          <button
        ...
        {/* ── No signals matching anything right now ── */}
        ...
        {/* ── Hero + runner-ups ── */}
        {!isLoading && heroSignal && (
          <>
            <HeroCard
              signal={heroSignal}
              onOpenChart={() => setChartSymbol(heroSignal.score.symbol)}
            />
              ...
              <div className="mt-7">
                <div className="flex items-baseline gap-2 mb-3">
                  ...
                  <span className="text-[11px] text-txt-muted font-mono">
                    {runnerUps.length} more high-fit signals
                  </span>
                </div>
        ...
        {/* ── Market regime strip ── */}
        {data?.regime && <RegimeStrip regime={data.regime} />}
...
function HeroCard({
  ...
  signal: SetupCandidate;
  onOpenChart: () => void;
}) {
  const { score, plan, thesis, fitScore, setupType } = signal;
  ...
  return (
    <div className="relative rounded-[16px] border border-border bg-gradient-to-b from-surface-1 to-surface-0 overflow-hidden">
      {/* Top accent strip — setup type color */}
      <div
          ...
          <div>
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              <span className="text-[10.5px] font-mono uppercase tracking-[0.1em] text-txt-muted">
                · highest conviction · fit {fitScore}
              </span>
            </div>
      ...
      <div className="flex items-start justify-between gap-3 mb-2.5">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span
              className="px-1.5 py-0.5 rounded text-[9px] font-mono uppercase tracking-[0.08em] font-semibold"
              style={{
                background: `${meta.color}1a`,
                color: meta.color,
                border: `1px solid ${meta.color}33`,
            ...
            <span className="text-[10px] font-mono uppercase tracking-[0.08em] text-txt-muted">
...
function PlanCell({
  ...
  return (
    <div className="rounded-[10px] border bg-bg-base px-3.5 py-3 border-border">
