...
const modules = [
  ...
  },
  {
    id: "risk",
    label: "Risk Engine",
    tagline: "Sizing & stress",
    desc: "Risk score, position sizing, stress sim.",
    icon: ShieldAlert,
  },
  {
    id: "alerts",
...
export function LandingScreen({ onEnter }: { onEnter: () => void }) {
  ...
  return (
    <div
      className="h-screen w-screen relative overflow-hidden bg-[#0a0a0a] cursor-pointer"
      onClick={stage === "intro" ? goToHub : undefined}
...
function IntroStage() {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 text-white/60 text-[11px] font-mono uppercase tracking-[0.25em]">
